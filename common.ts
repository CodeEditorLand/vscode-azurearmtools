...
export const langServerDotnetVersion = "8.0";
...
export const downloadDotnetVersion = "8.0";
...
export namespace configKeys {
	...
	export const checkForMatchingParameterFiles =
	...
	export const codeLensForResourceParentsAndChildren =
		"codelens.resourceChildren";
}

export namespace notifications {
	export const requestOpenLinkedTemplate =
		"arm-template/requestOpenLinkedTemplate";
	...
	export namespace Diagnostics {
		export const codeAnalysisStarting =
			"arm-template/diag-codeAnalysisStarting";
...
export namespace globalStateKeys {
	...
	export namespace messages {
		export const bicepMessagePostponedUntilTime =
			"bicepMessagePostponedUntilTime";
	}
}
...
export namespace templateKeys {
	...
	// Nested templates
	export const nestedDeploymentExprEvalOptions =
...
export const deploymentsResourceTypeLC: string =
