...
export class RequiresLanguageServer implements ITestPreparation {
	public static readonly instance: RequiresLanguageServer =
		new RequiresLanguageServer();
...
export function testWithLanguageServer(
	expectation: string,
...
export function testWithLanguageServerAndRealFunctionMetadata(
	expectation: string,
	callback?: (this: Context) => Promise<unknown>
): Test {
	return testWithPrep(
		expectation,
		[UseRealFunctionMetadata.instance, RequiresLanguageServer.instance],
		callback
	);
}
