...
suite("linkedTemplateScheme", () => {
	suite("removeLinkedTemplateScheme", () => {
		test("not there -> noop", () => {
			const uriString =
				"https://fake.blob.core.windows.net/blobby/subfolder/child.json?sv=2019-12-12&si=sawdeploy&sr=b&sig=wsrxXCkFbk2IVpk489XIR0KDFyzJaeQHwFvTm5mdQcU%FF";
		...
		test("is there -> remove", () => {
			const uriString =
				"linked-template:https://fake.blob.core.windows.net/blobby/subfolder/child.json?sv=2019-12-12&si=sawdeploy&sr=b&sig=wsrxXCkFbk2IVpk489XIR0KDFyzJaeQHwFvTm5mdQcU%FF";
