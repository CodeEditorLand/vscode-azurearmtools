...
suite("Duration", () => {
	...
	suite("plus(Duration)", () => {
		test("With zero", () => {
			assert.deepEqual(
				...
				Duration.milliseconds(1).plus(Duration.zero)
			);
		});
		...
		test("With negative duration", () => {
			assert.deepEqual(
				Duration.milliseconds(-1),
				Duration.milliseconds(1).plus(Duration.milliseconds(-2))
			);
		});
	});
	...
	suite("dividedBy(number)", () => {
		test("With zero", () => {
			assert.throws(() => {
				Duration.milliseconds(20).dividedBy(0);
			});
		});
		...
		test("With 1", () => {
			assert.deepEqual(
				...
				Duration.milliseconds(20).dividedBy(1)
			);
		});
		...
		test("With 2", () => {
			assert.deepEqual(
				...
				Duration.milliseconds(20).dividedBy(2)
			);
		});
	});
	...
	suite("lessThanOrEqualTo(Duration)", () => {
		test("With less than duration", () => {
			assert.deepEqual(
				false,
				Duration.milliseconds(20).lessThanOrEqualTo(
	...
	suite("toString()", () => {
		test("With -1 milliseconds", () => {
			assert.deepEqual(
				"-1 milliseconds",
				Duration.milliseconds(-1).toString()
			);
		});
		...
		test("With 2 milliseconds", () => {
			assert.deepEqual(
				"2 milliseconds",
				Duration.milliseconds(2).toString()
			);
		});
		...
		test("With 1000 milliseconds", () => {
			assert.deepEqual(
				"1000 milliseconds",
				Duration.milliseconds(1000).toString()
			);
		});
	});
});
