...
suite("Schema validation", () => {
			...
			await testDiagnostics(
				{
					...
					"parameters": {
						"rgName": {
							...
							"metadata": {
								"description":
									"Name of the resourceGroup to create",
							},
						},
						"rgLocation": {
							"type": "string",
						...
						resources: [
							{
								...
								"properties": {
									"publicIpAllocationMethod":
										"[parameters('publicIpAddressType')]", // should be publicIPAllocationMethod
								},
								"SKU": {
									// should be sku
	...
	suite("More specific error messages for schema problems", async () => {
		...
		// TODO
		test(
			"https://devdiv.visualstudio.com/DevDiv/_boards/board/t/ARM%20Template%20Authoring/Stories/?workitem=1013538"
		);
	});
});
