...
suite("Expression validation", () => {
	testWithLanguageServer("templates/new-vm.jsonc", async () =>
		testDiagnosticsFromFile(
	...
	testWithLanguageServer("templates/errors.json", async () =>
		testDiagnosticsFromFile(
