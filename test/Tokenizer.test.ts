...
suite("Tokenizer", () => {
	...
	test("LeftCurlyBracket", () => {
		assert.deepStrictEqual(
			...
			new basic.Token("{", basic.TokenType.LeftCurlyBracket)
		);
	});
	...
	test("RightCurlyBracket", () => {
		assert.deepStrictEqual(
			...
			new basic.Token("}", basic.TokenType.RightCurlyBracket)
		);
	});
	...
	test("LeftSquareBracket", () => {
		assert.deepStrictEqual(
			...
			new basic.Token("[", basic.TokenType.LeftSquareBracket)
		);
	});
	...
	test("RightSquareBracket", () => {
		assert.deepStrictEqual(
			...
			new basic.Token("]", basic.TokenType.RightSquareBracket)
		);
	});

	test("LeftParenthesis", () => {
		assert.deepStrictEqual(
			basic.LeftParenthesis,
			new basic.Token("(", basic.TokenType.LeftParenthesis)
		);
	});

	test("RightParenthesis", () => {
		assert.deepStrictEqual(
			basic.RightParenthesis,
			new basic.Token(")", basic.TokenType.RightParenthesis)
		);
	});
	...
	test("Underscore", () => {
		assert.deepStrictEqual(
			basic.Underscore,
			new basic.Token("_", basic.TokenType.Underscore)
		);
	});
	...
	test("Period", () => {
		assert.deepStrictEqual(
			basic.Period,
			new basic.Token(".", basic.TokenType.Period)
		);
	});
	...
	test("Dash", () => {
		assert.deepStrictEqual(
			basic.Dash,
			new basic.Token("-", basic.TokenType.Dash)
		);
	});
	...
	test("Plus", () => {
		assert.deepStrictEqual(
			basic.Plus,
			new basic.Token("+", basic.TokenType.Plus)
		);
	});
	...
	test("Comma", () => {
		assert.deepStrictEqual(
			basic.Comma,
			new basic.Token(",", basic.TokenType.Comma)
		);
	});
	...
	test("Colon", () => {
		assert.deepStrictEqual(
			basic.Colon,
			new basic.Token(":", basic.TokenType.Colon)
		);
	});
	...
	test("SingleQuote", () => {
		assert.deepStrictEqual(
			basic.SingleQuote,
			new basic.Token(`'`, basic.TokenType.SingleQuote)
		);
	});
	...
	test("DoubleQuote", () => {
		assert.deepStrictEqual(
			basic.DoubleQuote,
			new basic.Token(`"`, basic.TokenType.DoubleQuote)
		);
	});
	...
	test("Backslash", () => {
		assert.deepStrictEqual(
			basic.Backslash,
			new basic.Token("\\", basic.TokenType.Backslash)
		);
	});
	...
	test("ForwardSlash", () => {
		assert.deepStrictEqual(
			basic.ForwardSlash,
			new basic.Token("/", basic.TokenType.ForwardSlash)
		);
	});
	...
	test("Asterisk", () => {
		assert.deepStrictEqual(
			basic.Asterisk,
			new basic.Token("*", basic.TokenType.Asterisk)
		);
	});
	...
	test("Space", () => {
		assert.deepStrictEqual(
			basic.Space,
			new basic.Token(" ", basic.TokenType.Space)
		);
	});
	...
	test("Tab", () => {
		assert.deepStrictEqual(
			basic.Tab,
			new basic.Token("\t", basic.TokenType.Tab)
		);
	});
	...
	test("CarriageReturn", () => {
		assert.deepStrictEqual(
			basic.CarriageReturn,
			new basic.Token("\r", basic.TokenType.CarriageReturn)
		);
	});
	...
	test("Letters()", () => {
		assert.deepStrictEqual(
			basic.Letters("abc"),
			new basic.Token("abc", basic.TokenType.Letters)
		);
	});
	...
	test("Digits()", () => {
		assert.deepStrictEqual(
			basic.Digits("123"),
			new basic.Token("123", basic.TokenType.Digits)
		);
	});
	...
	test("Unrecognized()", () => {
		assert.deepStrictEqual(
			basic.Unrecognized("&"),
			new basic.Token("&", basic.TokenType.Unrecognized)
		);
	});
	...
	suite("Tokenizer", () => {
		...
		suite("next()", () => {
			function nextTest(
				text: string,
				expectedTokens?: basic.Token | basic.Token[]
			): void {
				if (!expectedTokens) {
					expectedTokens = [];
