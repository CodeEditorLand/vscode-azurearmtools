...
export class Item {
	...
	public static fromFunctionMetadata(
		...
		return new Item({
			...
			span,
			kind:
				metadata.unqualifiedName === metadata.fullName
					? CompletionKind.tleFunction
					: CompletionKind.tleUserFunction,
	...
	public static fromParameterDefinition(
	...
	public static fromVariableDefinition(
