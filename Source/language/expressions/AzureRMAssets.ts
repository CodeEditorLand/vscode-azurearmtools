...
export class AzureRMAssets {
	...
	public static getFunctionsMetadata(): FunctionsMetadata {
		if (!AzureRMAssets._functionsMetadata) {
			...
			const array: BuiltinFunctionMetadata[] =
...
export class BuiltinFunctionMetadata
	implements IFunctionMetadata, INamedDefinition
{
	...
	constructor(
		...
		this._returnType =
			this.returnValueMembers.length > 0 ? "object" : undefined;
	}
