...
export class UserFunctionDefinition implements INamedDefinition {
	...
	public readonly definitionKind: DefinitionKind =
	...
	public get fullName(): string {
		...
		return `${this.namespace.nameValue.unquotedValue || "(none)"}.${
			this.nameValue.unquotedValue || "(none)"
		}`;
	}

	public get output(): OutputDefinition | undefined {
		return this._output.getOrCacheValue(() => {
			const output = Json.asObjectValue(
