...
export class FindReferencesAndErrorsVisitor extends TleVisitor {
	constructor(
		...
		private readonly _referenceListsMap: Map<
	...
	private addVariableRefOrError(
		...
		if (tleFunctionCall.argumentExpressions.length === 1) {
			...
			if (arg instanceof StringValue) {
				...
				} else if (this._scope.isInUserFunction) {
					this.addError(
						new Issue(
							arg.token.span,
