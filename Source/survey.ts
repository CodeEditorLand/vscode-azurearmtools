...
const surveyPrompt =
	"Could you please take 2 minutes to tell us how well the Azure Resource Manager Tools extension is working for you?";
		...
		callWithTelemetryAndErrorHandling(
			...
			async (context: IActionContext) => {
				...
				try {
					...
					if (
						sessionLengthMs <
						surveyConstants.activeUsageMsBeforeSurvey
					) {
						return;
					}
